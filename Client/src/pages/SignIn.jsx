  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        localStorage.setItem('token', responseData.user); // Store the token in localStorage
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <h1 className='text-black-2 text-2xl font-bold'>Welcome Admin</h1>
